      ...
      <div class="pure-u-11-24">
        ...
        <div class="pure-u-1">
            <svg width="480" height="360" version="1.1" xmlns="http://www.w3.org/2000/svg" 
                ...
                <!-- limiti del vassoio -->
                <g id="limits">
                    <rect x="0"                 y="0"               :width="minBordoX"  height="615"        style="fill:coral"/>
                    <rect x="0"                 y="0"               width="820"         :height="minBordoY" style="fill:coral"/>
                    <rect :x="820-minBordoX"    y="0"               :width="minBordoX"  height="615"        style="fill:coral"/>
                    <rect x="0"                 :y="615-minBordoY"  width="820"         :height="minBordoY" style="fill:coral"/>
                </g>
                <animate
                    xlink:href="#limits"
